...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        while sentence not in self.knowledge:
            ...
            for item in self.knowledge[:len(self.knowledge) - 1]:
                if sentence.cells.issubset(item.cells):
                    new_set = item.cells - sentence.cells 
                    new_count = item.count - sentence.count 
                    sentence = Sentence(new_set, new_count)
